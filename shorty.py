...
def main():
    ...
    parser.add_argument("-c", "--config", help="Path to your config file. Required.")
    parser.add_argument(
        "-o",
        "--output",
        help="Path to output site to. Defaults to " "current working directory.",
        default=os.getcwd(),
    )
    parser.add_argument(
        "-g",
        "--google-analytics",
        help="ID for a Google Analytics account " "for tracking. Optional.",
